...
const environments = [
  {name: "Red Barrels*", description: "*The environment features containers that will explode when interacted with."},
  {name: "Siege Weapons*", description: "*The environment features large siege weapons that reload slowly, luckily they are ready to be fired with once."},
  {name: "Ammo Boxes*", description: "*The environment features limited-use items."},
  {name: "Big Drops*", description: "*The environment features cliffs or similar drops that both players or their enemies can be pushed off of."},
  {name: "Doors*", description: "*The environment features chokepoints or even a number of closed doors that, when unlocked, can change the layout of the battlefield."},
  {name: "Interactables*", description: "*The environment features levers or buttons that change aspects of the battlefield."},
  {name: "Terrain*", description: "*The environment features regions that are more difficult to traverse or deal environmental damage."},
  {name: "Platforms*", description: "*The environment features differences in height."}
];
