const playerObjectives = [
  {name: "Deathmatch*",          description: "Destroy the opposition."},
  {name: "Sabotage*",            description: "Remove someone or something from the equation, preferable before the enemy uses it in their ritual."},
  {name: "Daring Escape*",       description: "Get to a safe point."},
  {name: "Hold the Fort*",       description: "Keep enemies out until reinforcements arrive."},
  {name: "Waves of Bad Guys*",   description: "Survive as long as possible as a new wave of monsters arrive every round."},
  {name: "Escort*",              description: "Defend another (player) character, probably until it can do it's thing to change the tides of battle."},
  {name: "Base Defense*",        description: "Defend an item in their home or some other place from being stolen or otherwise removed."},
  {name: "Yoink and Skedaddle*", description: "Grab a specific item and get out, preferably before the enemies notices them."},
  {name: "Peace Makers*",        description: "Make sure that two parties do not come to blows."},
  {name: "The Arrest*",          description: "Incapacitate and capture one of the enemies."}
];
