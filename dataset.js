...
// You can combine multiple datasets or use the same dataset multiple times
const reelConfig = {
  race: [race],
  keyword: [keywords],
  trait: [traits, traits],
  personal: [sexuality, gender, relationship],
  alignment: [alignment]
};

// Example configurations:
// trait: [traits, keywords]              // Combine traits and keywords
// trait: [traits, traits, keywords]      // Traits twice, plus keywords
// keyword: [keywords, keywords, keywords] // Triple the keyword pool
